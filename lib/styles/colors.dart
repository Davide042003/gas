...
class AppColors {
  static const Color backgroundDefault = Color(0xffF5694D);

  static const Color white = Color(0xffFDEEEB);
  static const Color whiteShadow = Color(0x66FDEEEB);
  static const Color whiteShadow55 = Color(0x8CFDEEEB);
